...
with st.sidebar:
    st.header(f"Upload Excel documents")
...
with col1:
    st.header(f"Chat with Excel using Dockling and ollama-mistral:latest model")

with col2:
    st.button("Clear chats", on_click=reset_chat)
...
# Accept user input
if prompt := st.chat_input("What insights do you want?"):
