...
def initialize_llm():
    initialized_llm = Ollama(model="qwen3", request_timeout=120.0)
...
with column1:
    st.header("Docling with Ollama(Qwen3 model)")

with column2:
    st.button("Clear chats", on_click=clear_chat_history)
...
if user_input := st.chat_input("What do you want to know about your document?"):
